...
class TestCalendar:
    ...
    def test_calendar_service_can_make_and_delete_event(self):
        ...
        result = self.google_calendar.create_event(evt, calendarId=SHARED_CALENDAR_ID)
        ...
        del_result = self.google_calendar.delete_event(result['id'], calendarId=SHARED_CALENDAR_ID)
